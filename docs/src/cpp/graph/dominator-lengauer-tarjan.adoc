...
[source, cpp]
----
include::./cpp/graph/dominator-lengauer-tarjan-simple.cpp[]
----

=== Verified

* AOJ: "0294: Catch a Thief": link:https://judge.u-aizu.ac.jp/onlinejudge/review.jsp?rid=6495424#1[source] (C++11, 0.17sec)
