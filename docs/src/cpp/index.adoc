...
* link:./range_query/segment_tree_beats_1.html[区間chmin, RMQ, and RSQ (Segment tree beats)]
* link:./range_query/segment_tree_beats_2.html[区間chmin/chmax, RMQ, RSQ, RAQ, RUQ (Segment tree beats)]
