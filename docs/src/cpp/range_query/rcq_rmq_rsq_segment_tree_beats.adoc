= 区間chmin, RMQ, and RSQ (Segment tree beats)
:title: {doctitle} - {pagetitle}

Segment tree beats (range chmin, rmq, and rsq)
...
[source, cpp]
----
include::./cpp/range_query/rcq_rmq_rsq_segment_tree_beats.cpp[]
----
