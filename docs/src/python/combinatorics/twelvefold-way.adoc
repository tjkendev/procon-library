...
- AOJ: "DPL_5_L: Probability - Ball and Boxes 12": (Python3) link:http://judge.u-aizu.ac.jp/onlinejudge/review.jsp?rid=3176170#1[source]
...
* AOJ: "DPL_5_I: Probability - Ball and Boxes 9": (Python3) link:http://judge.u-aizu.ac.jp/onlinejudge/review.jsp?rid=3175681#1[source]
