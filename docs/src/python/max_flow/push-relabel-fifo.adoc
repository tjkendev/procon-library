...
1. Push: capacityが残っている辺を通して、距離ラベルが小さい頂点にexcess flow分を流す
2. Relabel: activeな頂点の距離ラベルを貼り直す
...
* AOJ: "GRL_6_A: Network Flow - Maximum Flow": link:http://judge.u-aizu.ac.jp/onlinejudge/review.jsp?rid=3842664#1[source] (Python3, 0.03sec)
