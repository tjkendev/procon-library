...
構築の計算量は $O(N)$ となり、1回のクエリは $O(\sqrt{N})$ となる。
...
* AOJ: "GRL_5_C: Tree - Lowest Common Ancestor": (Python3) link:http://judge.u-aizu.ac.jp/onlinejudge/review.jsp?rid=3156372#1[source]
